# Credit
This image is based on [Shah91n/WeaviateDBCluster](https://github.com/Shah91n/WeaviateDBCluster). All credit to the original author - this fork only looks to publish an image for convenience (TBD)
